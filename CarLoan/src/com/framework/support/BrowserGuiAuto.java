...
public class BrowserGuiAuto {
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3ClickByName(String ieTitle, int ieIndex,
			String objectName, int ObjectIndex) {
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3ClickByLinkText(String ieTitle, int ieIndex,
			String linkText) {
	...
	/**
	 * click on browser object, found by linktext, default index 0, using au3
	 * libs</BR> you can use it like this: ieAU3ClickByLinkText("窗口标题", "link
	 * texts");
	 * 
	 * @param ieTitle
	 *            ie window title
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3SendKeysById(String ieTitle, int ieIndex, String objectId,
			String textContent) {
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3SendKeysById(String ieTitle, String objectId,
			String textContent) {
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3SendKeysByName(String ieTitle, int ieIndex,
			String objectName, int ObjectIndex, String textContent) {
	 ...
	 * @throws RuntimeException
	 */
	public void ieAU3SendKeysByName(String ieTitle, String objectName,

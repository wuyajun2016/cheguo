...
public class MyTaskFinanceManagerTest extends WebdriverBaseCase {
	...
	private Logger logger = Logger.getLogger(MyTaskFinanceManagerTest.class);
	...
	public void myTaskFinanceManager() {
		...
		try {
			...
			HomePage = mytaskfinancemanagerdetailtodo.MyTaskPageFinanceManager(1,CustomerManagerName);

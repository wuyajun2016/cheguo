...
public class MyTaskFinanceDepartmentAccountTest extends WebdriverBaseCase {
	...
	private MyTaskFinanceDepartmentAccountDetailToDo mytaskfinancedepartmentaccountdetailtodo;
	protected WebdriverBaseApi webDriver;
	private Logger logger = Logger.getLogger(MyTaskFinanceDepartmentAccountTest.class);
	...
	public void myTaskFinanceDepartmentAccount() {
		boolean flag = false;
		beforeTest("myTaskFinanceDepartmentAccount");
		try {
			HomePage = new HomePage(webDriver);
			UserInfo = (UserInfo) FrameworkDao.getRandomObjectByParam(
					"UserInfo.getUserByParam", "testLogin");
			...
			mytaskfinancedepartmentaccountdetailtodo = HomePage.goMyTaskFinanceDepartmentAccountDetailToDo();
			HomePage = mytaskfinancedepartmentaccountdetailtodo.MyTaskPageFinanceDepartmentAccount(CustomerManagerName);

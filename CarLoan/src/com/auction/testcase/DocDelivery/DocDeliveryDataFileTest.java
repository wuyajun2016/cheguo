 ...
 *
 */
public class DocDeliveryDataFileTest extends WebdriverBaseCase{
	...
	public void DocDeliveryDataReVerify() {
		...
		try {
			...
			HomePage = HomePage.goMyTaskPage(0).MyTaskPageStartCredit().goDocDeliveryDataFileDetailToDo().DocDeliveryDataFile(CustomerManagerName);
		} catch (Exception e) {
			logger.error("testLogin error：", e);
		}
	}

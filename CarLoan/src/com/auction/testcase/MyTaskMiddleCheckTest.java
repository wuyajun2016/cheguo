...
public class MyTaskMiddleCheckTest extends WebdriverBaseCase {
	...
	private MyTaskMiddleCheckDetailToDo mytaskmiddlecheckdetailtodo;
	protected WebdriverBaseApi webDriver;
	private Logger logger = Logger.getLogger(MyTaskMiddleCheckTest.class);
	...
	public void MyTaskMiddleCheck() {
		boolean flag = false;
		beforeTest("MyTaskMiddleCheck");
		try {
			HomePage = new HomePage(webDriver);
			UserInfo = (UserInfo) FrameworkDao.getRandomObjectByParam(
					"UserInfo.getUserByParam", "testLogin");
			...
			mytaskmiddlecheckdetailtodo = HomePage.goMyTaskMiddleCheckDetailToDo();
			HomePage = mytaskmiddlecheckdetailtodo.MyTaskPagePrimaryCheck(CustomerManagerName);

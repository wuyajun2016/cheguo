...
public class MyTaskFinanceDepartmentHeadTest extends WebdriverBaseCase {
	...
	private MyTaskFinanceDepartmentHeadDetailToDo mytaskfinancedepartmentheaddetailtodo;
	protected WebdriverBaseApi webDriver;
	private Logger logger = Logger.getLogger(MyTaskFinanceDepartmentHeadTest.class);
	...
	public void myTaskFinanceDepartmentHead() {
		boolean flag = false;
		beforeTest("myTaskFinanceDepartmentHead");
		try {
			HomePage = new HomePage(webDriver);
			UserInfo = (UserInfo) FrameworkDao.getRandomObjectByParam(
					"UserInfo.getUserByParam", "testLogin");
			...
			mytaskfinancedepartmentheaddetailtodo = HomePage.goMyTaskFinanceDepartmentHeadDetailToDo();
			HomePage = mytaskfinancedepartmentheaddetailtodo.MyTaskPageFinanceDepartmentHead(CustomerManagerName);

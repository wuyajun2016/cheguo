...
public class MyTaskBranchCompanyAccountTest extends WebdriverBaseCase {
	...
	private Logger logger = Logger.getLogger(MyTaskBranchCompanyAccountTest.class);
	...
	public void myTaskFinanceDepartmentAccount() {
		...
		try {
			...
			HomePage = mytaskbranchcompanyaccountdetailtodo.MyTaskPageBranchCompanyAccount(1,CustomerManagerName);

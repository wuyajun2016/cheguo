...
public class MyTaskAutoFinanceTest extends WebdriverBaseCase {
	...
	private MyTaskAutoFinanceDetailToDo mytaskautofinancedetailtodo;
	protected WebdriverBaseApi webDriver;
	private Logger logger = Logger.getLogger(MyTaskAutoFinanceTest.class);
	...
	public void myTaskAutoFinance() {
		boolean flag = false;
		beforeTest("myTaskAutoFinance");
		try {
			HomePage = new HomePage(webDriver);
			UserInfo = (UserInfo) FrameworkDao.getRandomObjectByParam(
					"UserInfo.getUserByParam", "testLogin");
			...
			mytaskautofinancedetailtodo = HomePage.goMyTaskAutoFinanceDetailToDo();
			HomePage = mytaskautofinancedetailtodo.MyTaskPageAutoFinance(CustomerManagerName);

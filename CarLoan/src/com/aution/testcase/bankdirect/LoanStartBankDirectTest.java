...
public class LoanStartBankDirectTest extends WebdriverBaseCase {
	...
	private Logger logger = Logger.getLogger(LoanStartBankDirectTest.class);
...
//			FrameworkDao.addcredit(stCredit);
	...
	public void testLogin() {
		...
		try {
			...
			System.out.println("111----------------"+CustomerManagerName+"--------------------");
	...
	public void loanstart() {
		...
		try {
			...
			UserInfo = (UserInfo) FrameworkDao.getRandomObjectByParam(
					"UserInfo.getUserByParam", "testLogin");
			CustomerManagerName = UserInfo.getLoginname();
			System.out.println("222----------------"+CustomerManagerName+"--------------------");
			HomePage.goMyTaskLoanStartDetailToDo().MyTaskPageStartCredit(2,CustomerManagerName,1,carname);

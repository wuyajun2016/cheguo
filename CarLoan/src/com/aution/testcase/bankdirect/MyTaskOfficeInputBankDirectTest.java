...
public class MyTaskOfficeInputBankDirectTest extends WebdriverBaseCase {
	...
	private Logger logger = Logger.getLogger(MyTaskOfficeInputBankDirectTest.class);
...
//				+ captureName);
	...
	public void myTaskOfficeInput() {
		...
		try {
			...
			HomePage = mytaskofficedetailtodo.MyTaskPageStartCredit(0,CustomerManagerName,maritalstatus,customeralready,relationship);

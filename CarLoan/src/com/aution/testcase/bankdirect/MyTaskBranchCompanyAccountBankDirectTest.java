...
public class MyTaskBranchCompanyAccountBankDirectTest extends WebdriverBaseCase {
	...
	private MyTaskBranchCompanyAccountDetailToDo mytaskbranchcompanyaccountdetailtodo;
	protected WebdriverBaseApi webDriver;
	private Logger logger = Logger.getLogger(MyTaskBranchCompanyAccountBankDirectTest.class);
	...
	public void myTaskFinanceDepartmentAccount() {
		...
		try {
			...
			mytaskbranchcompanyaccountdetailtodo = HomePage.goMyTaskBranchCompanyAccountDetailToDo();
			HomePage = mytaskbranchcompanyaccountdetailtodo.MyTaskPageBranchCompanyAccount(2,CustomerManagerName);
